...
const BookDetails = ({ book }) => {
  ...
  return (
    <div className="relative not-first:before:absolute not-first:before:top-0 not-first:before:left-0 not-first:before:w-full not-first:before:h-0.5 lg:not-first:before:h-2 not-first:before:rounded-[100%] not-first:before:bg-neutral-200 not-first:mt-20 not-first:pt-20">
      <div
      ...
      >
        ...
        <div
          className={`w-full md:w-[65%] flex flex-col gap-6 max-lg: text-center ${
            book.imgRight ? "lg:pr-16" : "lg:pl-16"
          }`}
        >
          ...
          <div className="mt-5">
            <div className="flex flex-wrap lg:h-16 items-center bg-neutral-100 border border-[#D1D1D1] rounded-lg overflow-hidden">
              <div className="grow shrink text-center flex h-full max-lg:py-5 items-center justify-center lg:justify-start gap-4 px-8 bg-[#fbfaf7] border-r border-[#D1D1D1]">
                <h5 className="leading-none">Price:</h5>
                <span className="text-xl inline-flex items-center justify-center gap-1 leading-none">
                  <span>$</span>
