    ...
    <div className="border border-[#D1D1D1] p-[30px]">
      ...
      <table className="border-separate border-spacing-0 w-full">
        ...
        <tfoot>
          ...
          <tr>
            <td className="p-[18px_30px] text-sndry-600 font-bold bg-neutral-100 border border-r-0 border-t-0 border-[#D1D1D1]">
              Total
            </td>
            <td className="p-[18px_30px] text-sndry-600 font-bold bg-neutral-100 border border-t-0 border-[#D1D1D1]">
              ${total.toFixed(2)}
            </td>
          </tr>
        </tfoot>
